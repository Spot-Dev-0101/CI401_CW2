...
public class audioplugin_GamestroGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Gamestro"; } }
    public override string Description    { get { return "Gamestro"; } }
    public override string Vendor         { get { return "Filmstro Ltd."; } }

    //==============================================================================
	[DllImport("audioplugin_Gamestro")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Gamestro")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Gamestro")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Gamestro")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Gamestro")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Gamestro")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Gamestro")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
